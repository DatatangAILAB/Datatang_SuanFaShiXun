...
from pyner.utils.utils import pkl_read,pkl_write,text_write
...
class DataTransformer(object):
    ...
    def build_vocab(self):
        if os.path.isfile(self.vocab_path):
            ...
            count = Counter()
            with open(self.all_data_path, 'r',encoding='utf-8') as fr:
    ...
    def sentence2id(self,raw_data_path=None,raw_target_path  =None,x_var = None,y_var = None):
        ...
        if self.is_train_mode:
            if os.path.isfile(self.train_file) and os.path.isfile(self.valid_file):
                return True
            sentences, labels = [], []
            with open(raw_data_path, 'r',encoding='utf-8') as fr_x,open(raw_target_path,'r') as fr_y:
            ...
            if os.path.isfile(self.test_file):
                return True
            sentences,labels = [],[]
            with open(raw_data_path, 'r',encoding='utf-8') as fr_x:
